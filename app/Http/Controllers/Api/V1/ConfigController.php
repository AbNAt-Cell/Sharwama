...
class ConfigController extends Controller
{
    ...
    public function configuration(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                'product_image_url' => asset('public/upload/product'),
                'customer_image_url' => asset('public/upload/profile'),
                'banner_image_url' => asset('public/upload/banner'),
                'category_image_url' => asset('public/upload/category'),
                'category_banner_image_url' => asset('public/upload/category/banner'),
                'review_image_url' => asset('public/upload/review'),
                'notification_image_url' => asset('public/upload/notification'),
                'restaurant_image_url' => asset('public/upload/restaurant'),
                'delivery_man_image_url' => asset('public/upload/delivery-man'),
                'chat_image_url' => asset('public/upload/conversation'),
                'promotional_url' => asset('public/upload/promotion'),
                'kitchen_image_url' => asset('public/upload/kitchen'),
                'branch_image_url' => asset('public/upload/branch'),
                'gateway_image_url' => asset('public/upload/payment_modules/gateway_image'),
                'payment_image_url' => asset('public/assets/admin/img/payment'),
                'cuisine_image_url' => asset('public/upload/cuisine'),
            ],
